...
os.environ["mps_VISIBLE_DEVICES"] = ctx
USE_mps = args.use_gpu
DEVICE = torch.device("mps" if args.use_gpu else "cpu")
print("mps:", USE_mps, DEVICE)
...
# create an adjacent matrix to calculate the Chebyshev polynomial convolution kernel
