...
def scaled_Laplacian(W):
    ...
    L = D - W # (adjacency matrix)

    # Convert eigenvalue diagonal matrix values to [-1, 1]
...
def cheb_polynomial(L_tilde, K):
    ...
    Parameters
    ----------
    L_tilde: scaled Laplacian, np.ndarray, shape (N, N) 2L/lambda_max - I
